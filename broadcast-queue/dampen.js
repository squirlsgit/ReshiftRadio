...
module.exports = {
  ...
  async execute(message, ...args) {
    ...
    radio.blackout(voicechannel).then(() => message.channel.send(`Disabled radio on ${voicechannel.name}`).catch(err => message.channel.send(`Could not disable radio on ${voicechannel.name} because ${err.message}`));
